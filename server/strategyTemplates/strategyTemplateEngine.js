...
const TEMPLATE_LIBRARY = [
  createStrategyTemplate({
    ...
    defaultTimeframe: '5m',
    conditions: [
      { source: 'sessionContext', field: 'openingGapPercent', operator: '>=', value: 0.75, timeframe: '5m', enabled: true },
      { source: 'sessionContext', field: 'gapDirection', operator: 'exists', timeframe: '5m', enabled: true },
      { source: 'sessionContext', field: 'minutesSinceOpen', operator: '>=', value: 15, timeframe: '5m', enabled: true },
      { source: 'sessionContext', field: 'vwapDistance', operator: 'exists', timeframe: '5m', enabled: true },
      { source: 'sessionContext', field: 'sessionBias', operator: 'exists', timeframe: '5m', enabled: true },
